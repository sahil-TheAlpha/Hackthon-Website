...
include("sessions.php");
	...
	{
		$id = $_GET['id'];
		$res= mysqli_query($con,"SELECT * FROM rules WHERE id='$id'");
	...
	<div class="container-fluid">
      ...
      <div class="col-sm-2 col-md-2 left">
        ...
        <ul class="nav nav-pills nav-stacked md-pills" id="main">
          ...
          <li class="list-item" active><a href="rules.php" class="text-uppercase font-weight-bold"><span><i class="fas fa-star"></i>&nbsp;</span> Rules</a>
          </li>
          ...
          <li class="list-item"><a href="mentors.php" class="text-uppercase font-weight-bold"><span><i class="fas fa-code"></i>&nbsp;</span>Mentors and Speakers</a>
			...
			<div class="col-sm-4 col-md-4 center">
				<div class="card">
					<div class="card-header h1 font-weight-bold text-uppercase text-center">Edit the Rules</div>
					<div class="card-body">
						<div class="form">
              <form action="edit_rule.php" method="post">
							<div class="form-group">
								<label for="description">Rule Description</label>
								<textarea type="text" name="rules" id="description" class="form-control" rows="5"><?php echo $row['rules']; ?></textarea>
							</div>
              <div class="form-group">
                <input type="hidden" name="id" value="<?php echo $row['id']; ?>" class="form-control">
					...
					<div class="card-footer">
						<div class="text-center">
							<button class="btn font-weight-bold text-white" name="edit">Edit Rule</button>
						</div>
					</div>
				</div></form>
			</div>
