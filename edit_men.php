  ...
  function GetImageExtension($imagetype)
   {
	...
	{
		$id = $_GET['id'];
		$res= mysqli_query($con,"SELECT * FROM mentors WHERE id='$id'");
    ...
    $pos = $_POST['pos'];
		...
		$sql = "UPDATE mentors SET name='$name',desig='$desig',comp='$comp',pos='$pos',imgpath='$fileimg' WHERE id='$id'";
    $res 	 = mysqli_query($con,$sql) or die("Could not update!");
  		echo "<meta http-equiv='refresh' content='0;url=mentors.php'>";
		}
		else{
			$sql = "UPDATE mentors SET name='$name',desig='$desig',comp='$comp',pos='$pos' WHERE id='$id'";
	    $res 	 = mysqli_query($con,$sql) or die("Could not update!");
	  		echo "<meta http-equiv='refresh' content='0;url=mentors.php'>";
		}
  	}
...
<body>
	<div class="container-fluid">
		<div class="row">
            ...
            <div class="form"> 	<form action ="edit_men.php" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input type="radio" name="pos" value="Mentor" id="Mentor" value="<?php echo $row['pos']; ?>">
                  <label for="speaker">Speaker</label>
                <input type="radio" name="pos" value="Speaker" id="Speaker" value="<?php echo $row['pos']; ?>">
              </div>
							<div class="form-group">
